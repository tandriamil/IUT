...
* La  partie "Sauvegarder" pour pouvoir sauvegarder par s�rialisation l'annuaire avec les contacts rajoutés si il y en a dans un fichier annuaire.out
...
Une vérification du nom du contact à modifier a été mise en place, et un message d'erreur s'affiche si celui-ci n'est pas présent dans l'annuaire

* La partie "Supprimer" permettant de supprimer un contact de l'annuaire, avec les m�mes conditions de vérification que pour la partie "Modifier".
