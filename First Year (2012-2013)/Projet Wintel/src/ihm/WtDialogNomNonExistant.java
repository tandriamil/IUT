...
/**
*Classe de la boite de dialogue de la notification de nom non existant
*/
public class WtDialogNomNonExistant extends JDialog {
//Attributs
...
//Methodes
	/**
	*Constructeur de la classe WtDialogNomNonExistant
	*@param parent Fenetre parent
	*/
	public WtDialogNomNonExistant(WtDialog parent) {
	...
	*/
	private void creerInterface() {
		//Creation du texte
		String text = "Nom n'existant pas dans l'Annuaire !";
