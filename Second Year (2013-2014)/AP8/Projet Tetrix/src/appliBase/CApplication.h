...
//-----------------------------------------------------------------
#include "Common.h"				// données données à la souris
...
protected:
	...
	// données membres
	//----------------------------------------------------------
	WindowSetup*	m_windowSetUp;	///< infos données à la fenêtre (pointeur car paratagé par deux objets)
	CRenderer		m_renderer	;	///< Déclaration du renderer
	UserEvents*		m_UserEvents;	///< infos données à la souris/caméra (pointeur car paratagé par deux objets)
