...
/**
	\brief Constructor of CZ2Piece
*/
CZ2Piece::CZ2Piece(unsigned int dim, int iX, int iY, const CVector3& color) : CPieceAbstract(dim, iX, iY, color) {
	//Prints a log message
	cout << "CZ2Piece created in case " << this << endl;
}


/**
	\brief Desctructor of CZ2Piece
*/
CZ2Piece::~CZ2Piece() {
	cout << "CZ2Piece in case " << this << " deleted";
}
