//Test class of CZ1Piece

#include "testCZ1Piece.h"


/**
	\brief Main method to test the CZ1Piece class
 */
...
//Initialisation
	...
	//Creates some objects CZ1Piece
	CZ1Piece* c1 = new CZ1Piece(3, 500, 450, color);
	CZ1Piece* c2 = new CZ1Piece(3, 400, 350, color);
