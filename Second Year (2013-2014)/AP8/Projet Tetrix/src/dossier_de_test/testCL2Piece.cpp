//Test class of CL2Piece

#include "testCL2Piece.h"


/**
	\brief Main method to test the CL2Piece class
 */
...
//Initialisation
	...
	//Creates some objects CL2Piece
	CL2Piece* c1 = new CL2Piece(3, 500, 450, color);
	CL2Piece* c2 = new CL2Piece(3, 400, 350, color);
