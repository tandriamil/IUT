...
#ifndef __PROJET_TETRIS_PIECE_H__	// routine qui sert à pas inclure 2 fois le même fichier
...
private:
	...
	*/
	...
	/**
		...
		\param 3: dimension (cot�) du carré
		\param 4: couleur
	*/
...
#endif // __ProjetTetris_PIECE_H__ fin de la routine
