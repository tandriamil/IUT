...
* Groupe: B1
* File: AccountConnectionErrorView.php
*/
...
$page=new Page();
$page->setTitle("Music Online - Problème de connexion!");
...
//Création du header
$header = new Header(1, 'Problème de connexion!');
...
$divContenuPrincipal->addElement(new Text("Problème de connexion!"));
$divContenuPrincipal->addElement(new Text("<div><a class=\"boutonRetour\" href=\"?welcome\">Retour</a></div>"));
