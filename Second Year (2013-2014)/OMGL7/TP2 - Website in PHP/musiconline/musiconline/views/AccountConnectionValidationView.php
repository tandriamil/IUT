...
* Groupe: B1
* File: AccountConnectionValidationView.php
*/
...
$page=new Page();
$page->setTitle("Music Online - Connexion réussie");
...
//Création du header
$header = new Header(1, 'Félicitation! Connexion réussie!');
...
$divContenuPrincipal->addElement(new Text("Connexion réussie!"));
