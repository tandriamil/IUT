...
$page=new Page();
$page->setTitle("Music Online - Problème création compte!");
...
//Création du header
$header = new Header(1, 'Problème lors de la création de votre compte!');
...
$divContenuMenu->addElement(new Text("<div><a class=\"nav\" href=\"\#\">Se connecter</a></div>"));
$divContenuMenu->addElement(new Text("<div><a class=\"nav\" href=\"\#\">Créer un Compte</a></div>"));
...
$divContenuPrincipal->addElement(new Text("Problème lors de la création de votre compte!!!"));
